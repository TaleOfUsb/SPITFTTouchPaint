...
#define DRAW_WINDOW_Y_STOP (ILI9341_TFTHEIGHT-30)
...
static PaintState State = PAINT_INIT;

static uint16_t UsedColors[USED_COLORS] = {ILI9341_BLACK, ILI9341_BLUE, ILI9341_GREEN, ILI9341_RED, ILI9341_ORANGE}; // Colors table

static uint16_t CurrentColor = ILI9341_BLACK; // Default color
